...
/*
    Max cores are given by the total core count per node / GPU count. ex two V100's and 16 cores is 8 cores per V100.

    ES1 Nodes have the following currently 6/28/24
    4:GTX2080TI -> 2 core per
    4:A40 64cores -> 16 cores per
    2:V100 8cores -> 4 cores per    !!!!(Exception is n0043 and n0044 which have 2:V100 16cores, so 8c per)!!!!
*/
